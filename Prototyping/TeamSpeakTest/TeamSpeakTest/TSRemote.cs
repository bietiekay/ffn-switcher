...
// Revisions |
//===========================================================================================
// 07/12/2008: BTK: fixed problem that not all channels were recognized
...
namespace TeamSpeakTest
{
	...
	internal class TSRemote
	{
		...
		public static TtsrChannelInfo [] Channels
		{
			get
			{
                int size = ServerInfo.ChannelCount;     // BtK, 12.06.08, fixed problem that not all channels were recognized
				int retval = 0;
