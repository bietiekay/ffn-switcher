    ...
    public partial class MainWindow : Form
    {
        ...
        private void connect_playbutton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    internalSwitcher.tsProcessor.AddPlayBeacon(FFN_Switcher.Properties.Settings.Default.ConnectFile);
                }
            }
            catch (Exception)
            {
        ...
        private void beacon_playbutton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    internalSwitcher.tsProcessor.AddPlayBeacon(FFN_Switcher.Properties.Settings.Default.GatewayBeaconFile);
                }
            }
            catch (Exception)
            {
        ...
        private void disconnect_playbutton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    internalSwitcher.tsProcessor.AddPlayBeacon(FFN_Switcher.Properties.Settings.Default.DisconnectFile);
                }
            }
            catch (Exception)
            {
        ...
        private void deaktiviert_playbutton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    internalSwitcher.tsProcessor.AddPlayBeacon(FFN_Switcher.Properties.Settings.Default.GatewayDisabledFile);
                }
            }
            catch (Exception)
            {
        ...
        private void rogerbeep_playbutton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    internalSwitcher.tsProcessor.AddPlayBeacon(FFN_Switcher.Properties.Settings.Default.RogerBeepFile);
                }
            }
            catch (Exception)
            {
        ...
        private void offline_playbutton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    internalSwitcher.tsProcessor.AddPlayBeacon(FFN_Switcher.Properties.Settings.Default.GatewayOfflineFile);
                }
            }
            catch (Exception)
            {
